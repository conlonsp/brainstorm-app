...
When you click on the ```View More``` button on a specific idea, you'll be able to read more about the idea, view commments, post a comment, and if it's your idea, you can make updates from this page.
